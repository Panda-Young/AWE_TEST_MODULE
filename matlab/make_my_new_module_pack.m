function [MM, NAME] = make_my_new_module_pack(GENDOC)
%
% make_my_new_module_pack(GENDOC)
% Generates the my_new_module library.
...
%
% [MM, NAME]=make_my_new_module_pack(GENDOC)
...
awe_generate_doc(MM, DOC_DIR, fullfile(DOC_DIR, '_my_new_module.html'), 'my_new_module');
